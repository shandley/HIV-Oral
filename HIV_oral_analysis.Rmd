...
p.prevdf1.base <- ggplot(prevdf1.base, aes(TotalAbundance, Prevalence / nsamples(ps1.base),color=Class)) +
...
p.prevdf1.24 <- ggplot(prevdf1.24, aes(TotalAbundance, Prevalence / nsamples(ps1.24),color=Class)) +
  geom_hline(yintercept = 0.03, alpha = 0.5, linetype = 2) +
  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +
  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_grid(~Phylum) +
  theme(legend.position="bottom") +
  ggtitle("Phylum Prevelence in All Samples\Week 24 Samples")
p.prevdf1.24
